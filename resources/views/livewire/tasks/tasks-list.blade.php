 <div class="w-7/12">
     ...
     @if ($this->tasks->count() > 0)
         <div class="px-6">
             @foreach ($this->tasks as $task)
                 <div
                     class="px-4 py-6 my-4 bg-white rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                     <div class="p-4 leading-normal">
                         <div class="flex justify-between mb-4">
                             ...
                             <span
                                 class="flex justify-end px-2 py-1 border rounded-md border-slate-200">{{ $task->deadline->diffForHumans() }}</span>
                         </div>
     ...
     @else
         <div class="p-2 mt-2 mb-12">
             <h1 class="text-2xl text-indigo-500 text-semibold">No Tasks.</h1>
         </div>
     @endif
 </div>
