<div class="w-4/12 mt-2 rounded-md bg-slate-200">
    <div class="px-6 mt-6">
        <div>
            <h1 class="text-2xl font-semibold text-center">Welcome, <span
        ...
        <div class="mt-4">
            ...
            <form wire:submit="save">
                ...
                <div class="flex justify-between mb-3">
                    <button type="submit"
                        class="flex px-4 py-2 text-white bg-indigo-500 rounded-md hover:bg-indigo-600">Submit
                        <div wire:loading>
                    ...
                    <button type="button" wire:click="refresh"
                        class="flex px-4 py-2 text-white rounded-md bg-slate-400 hover:bg-slate-500">Refresh
                    </button>
                </div>
            </form>
        </div>
